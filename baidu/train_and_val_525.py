...
train_id_map_label_file = './data/new_train.txt'

val_image_dir = './data/test1'
val_id_map_label_file = "./data/new_val.txt"


def train():
    pre_trained_weights = './model/vgg16.npy'
    # data_dir = ''
...
def continue_train():
    ...
    continue_train_log_dir = './log2/continue_train'
    train_save_dir = './log2/save'
